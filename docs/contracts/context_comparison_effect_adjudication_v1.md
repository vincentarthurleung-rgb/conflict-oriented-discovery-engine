# Context Comparison Effect Adjudication Contract v1

Status: **Proposed**

Schema version: `context_comparison_effect_adjudication_v1`

The machine-readable authority is `context_comparison_effect_adjudication_v1.schema.json`. Each decision is factor-scoped and retains immutable source provenance. Provider payloads are evidence, never edited adjudication records.
