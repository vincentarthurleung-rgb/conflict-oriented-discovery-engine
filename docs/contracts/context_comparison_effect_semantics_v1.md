# Context Comparison Effect Semantic Contract v1

Status: **Proposed**

This document defines a proposed semantic contract. It does not change the runtime schema, validate a scientific conclusion, or adjudicate any existing pair.
