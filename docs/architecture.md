...
| Fulltext prompt | `fulltext_experimental_observation_prompt_v8_results_anchor_contract` | `fulltext/fulltext_l1_v2.py` |
...
| Cache identity | `fulltext_l1_v2_cache_identity_v6_results_anchor_contract` | `fulltext/fulltext_l1_v2.py` |
