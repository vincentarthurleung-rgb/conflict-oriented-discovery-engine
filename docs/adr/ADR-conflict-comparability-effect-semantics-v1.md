# ADR: Conflict Comparability Effect Semantics v1

- Status: **Proposed**
- Decision scope: L4b semantic contract and adjudication envelope only
...
Model B is recommended. The contract remains Proposed and is not implemented
or activated in runtime. This effect contract is independent from the Accepted
decision to separate pipeline responsibilities.
