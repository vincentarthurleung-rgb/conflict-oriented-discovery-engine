        ...
        return {
            ...
            **data,
            ...
            "discovery_layers": {
                ...
                "relevant_oa_fulltext": [x for x in self._read_jsonl(self.path / "l35_fulltext_candidate_papers.jsonl") if x.get("candidate_tier") == "high_relevance_oa"],
                "relevant_non_oa_fulltext": [x for x in self._read_jsonl(self.path / "l35_fulltext_candidate_papers.jsonl") if x.get("candidate_tier") == "high_relevance_non_oa"],
                "blocked_low_relevance_oa": [x for x in self._read_jsonl(self.path / "l35_fulltext_candidate_papers.jsonl") if x.get("candidate_tier") == "low_relevance_oa"],
