...
METRIC_REGISTRY: dict[str, MetricSpec] = {
    ...
    "conflict_precision": MetricSpec("conflict_precision", "v1", ("conflict_gold", "conflict_predictions"), "micro", "conflict_pair", "status", "case_cluster"),
    "conflict_recall": MetricSpec("conflict_recall", "v1", ("conflict_gold", "conflict_predictions"), "micro", "conflict_pair", "status", "case_cluster"),
    "conflict_f1": MetricSpec("conflict_f1", "v1", ("conflict_gold", "conflict_predictions"), "micro", "conflict_pair", "status", "case_cluster"),
    "conflict_macro_f1": MetricSpec("conflict_macro_f1", "v1", ("conflict_gold", "conflict_predictions"), "macro", "conflict_pair", "status", "case_cluster"),
    "conflict_micro_f1": MetricSpec("conflict_micro_f1", "v1", ("conflict_gold", "conflict_predictions"), "micro", "conflict_pair", "status", "case_cluster"),
    "conflict_auprc": MetricSpec("conflict_auprc", "v1", ("conflict_gold", "conflict_scores"), "global", "conflict_pair", "not_applicable", "case_cluster"),
    "false_conflict_rate": MetricSpec("false_conflict_rate", "v1", ("conflict_gold", "conflict_predictions"), "micro", "conflict_pair", "status", "case_cluster", False),
    "missed_conflict_rate": MetricSpec("missed_conflict_rate", "v1", ("conflict_gold", "conflict_predictions"), "micro", "conflict_pair", "status", "case_cluster", False),
    "conflict_type_accuracy": MetricSpec("conflict_type_accuracy", "v1", ("conflict_gold_types", "conflict_prediction_types"), "mean", "conflict_pair", "status", "case_cluster"),
    "comparable_pair_precision": MetricSpec("comparable_pair_precision", "v1", ("gold_comparable", "predicted_comparable"), "micro", "conflict_pair", "status", "case_cluster"),
    "core_conflict_precision": MetricSpec("core_conflict_precision", "v1", ("core_conflict_gold", "core_conflict_predictions"), "micro", "conflict_pair", "status", "case_cluster"),
    "exploratory_evidence_recall": MetricSpec("exploratory_evidence_recall", "v1", ("gold_exploratory_evidence", "predicted_evidence"), "micro", "evidence", "status", "case_cluster"),
    "context_recall_at_1": MetricSpec("context_recall_at_1", "v1", ("gold_context_sets", "ranked_context_predictions"), "mean", "item", "status", "case_cluster"),
    "context_recall_at_3": MetricSpec("context_recall_at_3", "v1", ("gold_context_sets", "ranked_context_predictions"), "mean", "item", "status", "case_cluster"),
    "context_mrr": MetricSpec("context_mrr", "v1", ("gold_context_sets", "ranked_context_predictions"), "mean", "item", "status", "case_cluster"),
    "context_set_jaccard": MetricSpec("context_set_jaccard", "v1", ("gold_context_sets", "prediction_context_sets"), "mean", "item", "status", "case_cluster"),
    "minimal_context_exact_match": MetricSpec("minimal_context_exact_match", "v1", ("gold_minimal_context_sets", "predicted_minimal_context_sets"), "mean", "item", "status", "case_cluster"),
    "over_explanation_rate": MetricSpec("over_explanation_rate", "v1", ("gold_context_sets", "prediction_context_sets"), "mean", "item", "status", "case_cluster", False),
    "under_explanation_rate": MetricSpec("under_explanation_rate", "v1", ("gold_context_sets", "prediction_context_sets"), "mean", "item", "status", "case_cluster", False),
}
