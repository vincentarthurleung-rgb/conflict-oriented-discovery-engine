...
def _base(kind: str, source: dict, *, source_scope: str, source_mode: str) -> dict:
    ...
    return {
        ...
        "linked_paper_ids": _values(source, "linked_paper_ids", "paper_ids"),
        "linked_canonical_paper_ids": _values(source, "linked_canonical_paper_ids"),
        "linked_dois": _values(source, "linked_dois"),
