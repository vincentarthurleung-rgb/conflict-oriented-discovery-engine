...
def compute_batch_metrics(
    *, prompts: list[dict], candidates: list[dict], annotations: list[dict] | None = None,
    ...
    metrics = {
        ...
        "hypothesis_candidate_count": int((hypothesis_statistics or {}).get("hypothesis_candidate_count", 0)),
        "fulltext_grounded_hypothesis_count": int((hypothesis_statistics or {}).get("fulltext_grounded_hypothesis_count", 0)),
        "mechanism_grounded_hypothesis_count": int((hypothesis_statistics or {}).get("mechanism_grounded_hypothesis_count", 0)),
        "abstract_only_hypothesis_count": int((hypothesis_statistics or {}).get("abstract_only_hypothesis_count", 0)),
        "requires_manual_review_hypothesis_count": int((hypothesis_statistics or {}).get("requires_manual_review_hypothesis_count", 0)),
