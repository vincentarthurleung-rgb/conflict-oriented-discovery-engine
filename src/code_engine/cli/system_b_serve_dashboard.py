...
def main():
    ...
    print('SYSTEM_B_DASHBOARD_READY',flush=True);print(f'Dashboard available at http://{a.host}:{a.port}/',flush=True)
    try: serve(a.system_b_root,a.kg_root,a.host,a.port)
