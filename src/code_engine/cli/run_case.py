...
def build_parser():
    ...
    ft=p.add_mutually_exclusive_group(); ft.add_argument("--enable-fulltext-confirmation",action="store_true"); ft.add_argument("--disable-fulltext-confirmation",action="store_true")
...
def main(argv=None)->int:
    ...
    try:
        ...
        run_l35_pmc_oa_stage(final_run,enabled=fulltext_enabled,network_enabled=a.network,max_papers=a.fulltext_max_papers,include_near_conflicts=a.fulltext_include_near_conflicts)
