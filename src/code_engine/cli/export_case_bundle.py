...
def export_case_bundle(final_run:str|Path, case_profile:str|Path, output_root:str|Path="case_bundles")->tuple[Path,dict]:
    ...
    interpretation=lincs.get("interpretation") or ext.get("interpretation")
