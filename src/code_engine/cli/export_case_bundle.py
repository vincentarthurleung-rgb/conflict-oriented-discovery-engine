...
ARTIFACTS += ["non_comparable_direction_pairs.jsonl","non_comparable_direction_pair_summary.json"]
ARTIFACTS += ["l35_fulltext_discovery_escalation_summary.json","l35_fulltext_discovery_candidate_papers.jsonl","l35_fulltext_discovery_execution_records.jsonl","l35_fulltext_oa_resource_diagnostics.jsonl","l35_fulltext_discovery_selected_chunks.jsonl","l35_fulltext_l1_execution_records.jsonl","l35_fulltext_discovery_retrieval_results.jsonl","l35_fulltext_discovery_l1_claims.jsonl","l35_fulltext_discovery_observations.jsonl","l35_fulltext_discovery_reentry_summary.json","l35_fulltext_oa_candidate_papers.jsonl"]
...
def export_case_bundle(final_run:str|Path, case_profile:str|Path, output_root:str|Path="case_bundles", *, bundle_id_suffix:str|None=None, overwrite_bundle:bool=False, manifest_overrides:dict|None=None)->tuple[Path,dict]:
    ...
    manifest={"case_id":profile.case_id,"query":profile.query,"case_type":profile.case_type,"source_run_id":source_id,"final_run_id":run.name,
      ...
      **hypothesis_counts,
      ...
      "weak_conflict_candidate_count":int(_line_count(artifacts/"weak_conflict_candidates.jsonl") or 0),"non_comparable_direction_pair_count":int(_line_count(artifacts/"non_comparable_direction_pairs.jsonl") or 0),"fulltext_escalation_candidate_count":int(discovery.get("fulltext_escalation_candidate_count",0)),
      ...
      "selected_chunk_count":int(fulltext_discovery.get("selected_chunk_count",0)),"fulltext_l1_attempted_count":int(fulltext_discovery.get("fulltext_l1_attempted_count",0)),
      "fulltext_l1_success_count":int(fulltext_discovery.get("fulltext_l1_success_count",0)),"fulltext_l1_failed_count":int(fulltext_discovery.get("fulltext_l1_failed_count",0)),
      "fulltext_l1_status":fulltext_discovery.get("fulltext_l1_status"),"fulltext_claims_reentered_l2":int(fulltext_discovery.get("fulltext_claims_reentered_l2",0)),
      "fulltext_reviewable_graph_observation_count":int(fulltext_discovery.get("fulltext_reviewable_graph_observation_count",0)),"fulltext_weak_conflict_candidate_count":int(fulltext_discovery.get("fulltext_weak_conflict_candidate_count",0)),
