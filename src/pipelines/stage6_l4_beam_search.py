        ...
        for _ in range(k):
            ...
            for node in current_frontier:
                ...
                for idx in connected_edges:
                    neighbor = self.edge_index[1][idx].item()
...
def execute_l4_search_pipeline():
    print("[C.O.D.E. Stage 6] Starting Layer 4 Bounded Regularized Hypothesis Optimization Engine...")
    ...
    with open(L4_REPORT_PATH, "w", encoding="utf-8") as f:
        json.dump({
            ...
            "nature_methods_ready_ablation_proof": {
