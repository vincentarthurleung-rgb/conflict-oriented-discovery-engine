...
Complete Release 1.2 (Hardcore integration of XML default namespace physical cleaning mechanism to ensure 100% text extraction rate)
"""
...
# =====================================================================
# C.O.D.E. JCR MATRIX WITH MULTI-MODAL ALIASES & ISSN STRATEGY
# =====================================================================
JOURNAL_KNOWLEDGE_BASE = {
    "Nature": {
        "issn": ["0028-0836", "1476-4687"],
        "aliases": ["nature"],
        "metrics": {"if": 50.5, "weight": 1.0, "tier": "CNS"}
    },
    "Science": {
        "issn": ["0036-8075", "1095-9203"],
        "aliases": ["science"],
        "metrics": {"if": 44.7, "weight": 1.0, "tier": "CNS"}
    },
    "Cell": {
        "issn": ["0092-8674", "1097-4172"],
        "aliases": ["cell"],
        "metrics": {"if": 45.5, "weight": 1.0, "tier": "CNS"}
    },
    "Nature Medicine": {
        "issn": ["1078-8956", "1546-170X"],
        "aliases": ["nat med", "nat. med."],
        "metrics": {"if": 58.0, "weight": 0.95, "tier": "Top"}
    },
    "Nature Neuroscience": {
        "issn": ["1097-6256", "1546-1726"],
        "aliases": ["nat neurosci", "nat. neurosci."],
        "metrics": {"if": 21.2, "weight": 0.9, "tier": "Top"}
    },
    "Molecular Psychiatry": {
        "issn": ["1359-4184", "1476-5578"],
        "aliases": ["mol psychiatry", "mol. psychiatry"],
        "metrics": {"if": 11.1, "weight": 0.85, "tier": "Top"}
    },
    "Biological Psychiatry": {
        "issn": ["0006-3223", "1873-2402"],
        "aliases": ["biol psychiatry", "biol. psychiatry"],
        "metrics": {"if": 10.6, "weight": 0.8, "tier": "Top"}
    },
    "Trends in Neurosciences": {
        "issn": ["0166-2236", "1878-108X"],
        "aliases": ["trends neurosci", "trends neurosci."],
        "metrics": {"if": 14.6, "weight": 0.85, "tier": "Top"}
    },
    "Lancet Psychiatry": {
        "issn": ["2215-0366", "2215-0374"],
        "aliases": ["lancet psychiatry", "lancet psychiat"],
        "metrics": {"if": 30.8, "weight": 0.9, "tier": "Top"}
    },
    "eLife": {
        "issn": ["2050-084X"],
        "aliases": ["elife"],
        "metrics": {"if": 8.4, "weight": 0.8, "tier": "Top"}
    },
    "The Journal of Neuroscience": {
        "issn": ["0270-6474", "1529-2401"],
        "aliases": ["journal of neuroscience", "j neurosci", "j. neurosci."],
        "metrics": {"if": 5.3, "weight": 0.7, "tier": "JCR-Q1"}
    },
    "Neuropharmacology": {
        "issn": ["0028-3908", "1873-7064"],
        "aliases": ["neuropharmacology"],
        "metrics": {"if": 4.5, "weight": 0.65, "tier": "JCR-Q1"}
    },
    "Neuropsychopharmacology": {
        "issn": ["0893-133X", "1740-634X"],
        "aliases": ["neuropsychopharmacology"],
        "metrics": {"if": 6.6, "weight": 0.75, "tier": "JCR-Q1"}
    },
    "Translational Psychiatry": {
        "issn": ["2158-3188"],
        "aliases": ["transl psychiatry", "transl. psychiatry"],
        "metrics": {"if": 5.8, "weight": 0.7, "tier": "JCR-Q1"}
    },
    "Journal of Affective Disorders": {
        "issn": ["0165-0327", "1573-2517"],
        "aliases": ["j affect disorders", "j. affect. disorders", "j affect disord"],
        "metrics": {"if": 4.9, "weight": 0.65, "tier": "JCR-Q1"}
    },
    "International Journal of Neuropsychopharmacology": {
        "issn": ["1461-1457", "1469-5111"],
        "aliases": ["int j neuropsychopharmacol", "int. j. neuropsychopharmacol."],
        "metrics": {"if": 4.5, "weight": 0.65, "tier": "JCR-Q1"}
    },
    "European Neuropsychopharmacology": {
        "issn": ["0924-977X", "1873-7862"],
        "aliases": ["eur neuropsychopharmacol", "eur. neuropsychopharmacol."],
        "metrics": {"if": 4.4, "weight": 0.65, "tier": "JCR-Q1"}
    },
    "Scientific Reports": {
        "issn": ["2045-2322"],
        "aliases": ["sci rep", "sci. rep."],
        "metrics": {"if": 4.6, "weight": 0.6, "tier": "JCR-Q1"}
    },
    "Current Neuropharmacology": {
        "issn": ["1570-159X", "1875-6190"],
        "aliases": ["curr neuropharmacol", "curr. neuropharmacol."],
        "metrics": {"if": 4.6, "weight": 0.65, "tier": "JCR-Q1"}
    },
    "Frontiers in Psychiatry": {
        "issn": ["1664-0640"],
        "aliases": ["front psychiatry", "front. psychiatry"],
        "metrics": {"if": 4.8, "weight": 0.65, "tier": "JCR-Q1"}
    },
    "Pharmaceuticals": {
        "issn": ["1424-8247"],
        "aliases": ["pharmaceuticals"],
        "metrics": {"if": 5.1, "weight": 0.65, "tier": "JCR-Q1"}
    },
    "Bioinformatics": {
        "issn": ["1367-4803", "1460-2059"],
        "aliases": ["bioinformatics"],
        "metrics": {"if": 4.4, "weight": 0.7, "tier": "JCR-Q1"}
    },
    "Journal of Psychopharmacology": {
        ...
        "metrics": {"if": 3.2, "weight": 0.5, "tier": "JCR-Q2"}
    },
    "PLOS ONE": {
        "issn": ["1932-6203"],
        "aliases": ["plos one", "plos 1"],
        "metrics": {"if": 2.9, "weight": 0.4, "tier": "JCR-Q2"}
    }
}
DEFAULT_WEIGHT = {"if": 1.5, "weight": 0.2, "tier": "JCR-Q4_Trash"}
...
def resolve_journal_weight(journal_title, issn_list=None):
    ...
    if not journal_title:
        return DEFAULT_WEIGHT, True, "Unknown"
    ...
    return DEFAULT_WEIGHT, True, journal_title


def extract_full_text_paragraphs(root):
    """Extract all paragraphs from the body using in-memory parent mapping, supporting deeply nested <p> tags."""
    paragraphs_payload = []
...
def process_one_pmc(pmc_full_id):
    ...
    try:
        ...
        # 5. Journal weighting and full-text paragraph extraction
        ...
        # 6. Return complete payload including DOI
        return {
            "pmcid": pmc_full_id,
            "doi": doi,
            "article_title": title,
        ...
        print(f"\n Error parsing {pmc_full_id}: {e}")
        return None


def run_stage1_pipeline():
    print("🦅 [C.O.D.E. Stage 1] Launching multi-dimensional disambiguation weighting and global namespace cleaning stream based on Manifest contract...")
    
    if not os.path.exists(MANIFEST_PATH):
        print(f"❌ Error: Unsorted manifest file not found at {MANIFEST_PATH}. Please run Stage 0 first!")
        return
        
    with open(MANIFEST_PATH, "r", encoding="utf-8") as f:
        manifest = json.load(f)
    pmc_ids = manifest.get("papers", [])
    
    if not pmc_ids:
        print("⚠️ Manifest list is empty.")
        return
        
    audit_records = []
    journal_stats = {}
    
    for pmc_id in tqdm(pmc_ids, desc="Processing C.O.D.E. Payloads"):
        output_json_path = os.path.join(OUTPUT_PAYLOAD_DIR, f"{pmc_id}_payload.json")
        ...
        if os.path.exists(output_json_path):
            try:
                ...
                print(f"\n⚠️ Detected corrupted JSON cache {pmc_id}_payload.json, physically removing...")
                if os.path.exists(output_json_path):
                    os.remove(output_json_path)
        
        payload = process_one_pmc(pmc_id)
        if payload is None:
            continue
    ...
    print(f"\n✅ [Stage 1 Contract Closed Successfully]!")
    print(f"📂 Standardized JSON library ready ➡️ {OUTPUT_PAYLOAD_DIR}")
    print(f"📋 Quality audit panorama table committed ➡️ {AUDIT_CSV_PATH}")
    
    print("\n📊 [Debug Analytics] Top 10 Journal Distribution Matrix (intelligent disambiguation & namespace full integration):")
    for j, c in sorted(journal_stats.items(), key=lambda x: -x[1])[:10]:
        status = "✅ Matched & Weighted" if next((k for k in JOURNAL_KNOWLEDGE_BASE if k.lower() == j.lower()), None) else "❌ Unmatched (penalized)"
