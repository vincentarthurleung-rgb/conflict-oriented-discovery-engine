...
class ValidationAnchorsFromHypothesesTests(unittest.TestCase):
    def test_requirements_become_hypothesis_anchor_intents(self):
        hypotheses = [{"hypothesis_id": "H", "entities": [{"canonical_id": "S", "name": "s"}, {"canonical_id": "O", "name": "o"}], "linked_conflict_ids": ["C"], "linked_mechanism_path_ids": ["P"], "linked_canonical_paper_ids": ["PAPER"], "linked_dois": ["10/x"], "linked_titles": ["T"], "linked_journals": ["J"], "validation_requirements": [{"requirement_type": "expression_direction_check"}, {"requirement_type": "pathway_membership_check"}]}]
        ...
        self.assertEqual(hypothesis_anchors[0].linked_dois, ["10/x"])
