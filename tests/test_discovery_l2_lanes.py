...
from code_engine.discovery.lanes import build_discovery_lanes,synchronize_seed_metadata,validate_seed_metadata
...
class DiscoveryL2LaneTests(unittest.TestCase):
 ...
 def test_reviewable_lane_preserves_local_missing_year_unknown_direction(self):
  ...
  review=result["reviewable_graph"];self.assertEqual(len(review),3)
